...
SalesforceInteractions.init({
  ...
  function handleRouteChange() {
    ...
    SalesforceInteractions.init({
          ...
          },
          {
            ...
            onActionEvent: function (actionEvent, context) {
              ...
              SalesforceInteractions.sendEvent({
                ...
                interaction: {
                  name: SalesforceInteractions.OrderInteractionName
                    .PurchaseOrder,
                  order: {
                    id: "ORD-" + Date.now(),
                    lineItems: [buildLineItem(formEl)],
      ...
      // Deteksi navigasi SPA (Next.js App Router) tanpa bantuan React sama sekali.
      // Next.js memakai history.pushState/replaceState di balik layar setiap kali
      // pindah halaman (klik <Link>), jadi kita "sadap" kedua fungsi itu + event
      // popstate (tombol back/forward browser), lalu panggil reinit() begitu path
      // berubah.
      let lastPath = window.location.pathname;
